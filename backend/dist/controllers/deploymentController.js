...
exports.renderLiveDeployment = void 0;
const Pipeline_1 = __importDefault(require("../models/Pipeline"));
const Report_1 = __importDefault(require("../models/Report"));
const renderLiveDeployment = async (req, res) => {
    try {
        const { id } = req.params;
        const pipeline = await Pipeline_1.default.findById(id);
        if (!pipeline) {
      ...
      `);
        ...
        const deploymentReport = await Report_1.default.findOne({
            pipelineId: pipeline._id,
            reportType: 'deployment'
        });
        const repo = pipeline.githubRepo || 'Unknown Repository';
        const branch = pipeline.githubBranch || 'main';
...
exports.renderLiveDeployment = renderLiveDeployment;
